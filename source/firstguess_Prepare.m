...
function [firstguessStruct]= firstguess_Prepare( refInfo, commonDataInfo)
...
% end
% % data
% firstguessStruct.nnSetHorizon=nnSetHorizon;
% firstguessStruct.nnSuperSet=nnSuperSet;
% firstguessStruct.bcSuperSet=bcSuperSet;
% firstguessStruct.nnOptSet=nnOptSet;
% firstguessStruct.bcOptSet=bcOptSet;
...
firstguessStruct.get_nnSuperSetFunction=strcat(prefix, 'get_nnSuperSet');
firstguessStruct.get_nnOptSetFunction=strcat(prefix, 'get_nnOptSet');
firstguessStruct.get_aqipercellFunction=strcat(prefix, 'get_aqipercell');
...
firstguessStruct.get_aqi_per_cellFunction=strcat(prefix, 'do_aqi_per_cell');
...
firstguessStruct.get_isDeltaEmisFunction=strcat(prefix, 'get_isDeltaEmis');
firstguessStruct.get_isAggregatedEmisFunction=strcat(prefix, 'get_isAggregatedEmis');

% new MM 20160428
firstguessStruct.get_fillcomputesolFunction=strcat(prefix, 'fillcomputesol');
firstguessStruct.get_buildEmissionFunction=strcat(prefix, 'buildEmission');

firstguessStruct.is2InputFunction=strcat(prefix, 'is2Input');
firstguessStruct.is6InputFunction=strcat(prefix, 'is6Input');
