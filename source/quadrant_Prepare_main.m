...
%quadrantStruct.radius=4;
 ...
 quadrantStruct.get_aqi_DFunction=strcat(prefix, 'get_aqi_D');
 quadrantStruct.get_aqi_bcFunction=strcat(prefix, 'get_aqi_bc');
 quadrantStruct.get_aqi_nnFunction=strcat(prefix, 'get_aqi_nn');
 quadrantStruct.get_aqi_nnOptSetFunction=strcat(prefix, 'get_aqi_nnOptSet');
 quadrantStruct.get_fillcomputesolFunction=strcat(prefix, 'fillcomputesol');
 
 quadrantStruct.get_rebuildOrderedEmisFunction=strcat(prefix, 'rebuildOrderedEmis');
 quadrantStruct.get_bcSuperSetFunction=strcat(prefix, 'get_bcSuperSet');
